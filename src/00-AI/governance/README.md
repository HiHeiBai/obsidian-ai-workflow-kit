...
外部资料的分析、私人收藏和知识提炼见 `00-AI/pipeline/source-to-knowledge-workflow.md`。只有项目状态变化或确实需要接手时，才更新相应入口。
...
Use `00-AI/pipeline/source-to-knowledge-workflow.md` for analysis, private collection, and knowledge promotion. Update an entry point when project state changes or an actual handoff is needed.
