...
AI 读完 `00-入口/开始这里.md` 后，应该这样分流：

| 输入 | 知识类型 | 写回位置 |
|---|---|---|
| `call-notes.txt` | 项目状态 | `10-项目/product-launch/current-state.md` |
| `draft-positioning.md` | 候选决策 | `10-项目/product-launch/decisions.md` |
| `onboarding-research.pdf` | 资料证据 | `20-资料/01-示例/` |
| `todo-from-chat.md` | 临时任务记录 | 项目桥接卡下一步或 Inbox |
| 过程中反复出现的经验 | 可复用资产 | `30-经验资产/06-本地经验/` |
