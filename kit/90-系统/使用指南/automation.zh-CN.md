...
3. 让 Agent 按 `00-入口/开始这里.md` 写交接、更新项目状态和沉淀经验。
...
2. 把 `90-系统/示例/claude-code-hooks/stop-session-check.py` 复制到 `.claude/hooks/stop-session-check.py`。
3. 把 `90-系统/示例/claude-code-hooks/settings.example.json` 合并进 `.claude/settings.json`。
