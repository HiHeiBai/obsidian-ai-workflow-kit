...
kb_project: "10-项目/01-示例项目/README.md"
startup_files:
  - "00-入口/开始这里.md"
  - "10-项目/01-示例项目/current-state.md"
  - "10-项目/01-示例项目/decisions.md"
created: 2026-06-01
updated: 2026-07-18
...
- 如果同类项目会重复出现，把经验上浮到 `30-经验资产/06-本地经验/`。
