...
外部资料先进 `01-收件箱/网页剪藏/`，或直接进入 `20-资料/` 的资料分析卡。
...
|---|---|
| 只用于理解来源 | `20-资料/` |
| 影响某个项目动作 | `10-项目/<project>/` |
| 多个项目可复用 | `30-经验资产/` |
| 反复踩坑或稳定经验 | `90-系统/模板/TPL-问题知识卡-经验资产卡.md` 或 `30-经验资产/06-本地经验/` |
| 旧项目经验需要被 AI 复用 | [project-lesson-promotion-v1](项目经验沉淀机制-v1.md) + 对应项目桥接卡 |
| 影响当前优先级 | 对应项目桥接卡或 `10-项目/README.md` |
