...
| Path | Purpose |
|---|---|
| [`00-AI/START-HERE.md`](../src/00-AI/START-HERE.md) | The first file an AI agent should read |
| [`index.md`](../src/index.md) | Human-facing vault homepage |
| [`00-AI/AGENTS.md`](../src/00-AI/AGENTS.md) | Rules for AI agents such as Claude Code, Cursor, and Codex |
| [`00-AI/governance/`](../src/00-AI/governance) | Startup contract, review gates, write-back rules, maintenance loop |
| [`01-Inbox/`](../src/01-Inbox) | Temporary handoffs, queued/cross-session task cards, and web clips |
| [`00-AI/pipeline/`](../src/00-AI/pipeline) | How AI turns local materials into structured knowledge |
| [`00-AI/recall/`](../src/00-AI/recall) | Task-to-context maps and recall fields |
| [`00-AI/bases/`](../src/00-AI/bases) | Optional project, task, and source views installed in full mode |
| [`10-Projects/`](../src/10-Projects) | Project workspaces and bridge cards |
| [`20-SharedAssets/`](../src/20-SharedAssets) | Reusable methods, SOPs, and workflows |
| [`40-ExternalSources/`](../src/40-ExternalSources) | Source analysis cards, not copied third-party articles |
| [`00-AI/templates/`](../src/00-AI/templates) | Standard templates |
| [`docs/`](.) | First-run guides, diagrams, and user-facing walkthroughs |
| [`00-AI/scripts/`](../src/00-AI/scripts) | Small helper scripts for project cards and health checks |
