...
当前对话是默认执行上下文。只有任务需要排队、跨会话、等待外部条件或明确协调时，才写入 `01-Inbox/tasks/`。需要专业检查时，直接把检查视角写进任务。
...
| 路径 | 作用 |
|---|---|
| [`00-AI/START-HERE.md`](../src/00-AI/START-HERE.md) | AI Agent 第一个应该读的文件 |
| [`index.md`](../src/index.md) | 给人看的 vault 首页 |
| [`00-AI/AGENTS.md`](../src/00-AI/AGENTS.md) | 给 Claude Code、Cursor、Codex 等 AI agent 的规则 |
| [`00-AI/governance/`](../src/00-AI/governance) | 开工契约、审查门、写回规则、维护循环 |
| [`01-Inbox/`](../src/01-Inbox) | 临时交接、排队或跨会话任务卡、网页剪藏入口 |
| [`00-AI/pipeline/`](../src/00-AI/pipeline) | AI 如何把本机资料整理成结构化知识 |
| [`00-AI/recall/`](../src/00-AI/recall) | 任务到上下文的召回地图和召回字段 |
| [`00-AI/bases/`](../src/00-AI/bases) | Full 模式安装的项目、任务和资料动态视图 |
| [`10-Projects/`](../src/10-Projects) | 项目工作区和项目桥接卡 |
| [`20-SharedAssets/`](../src/20-SharedAssets) | 可复用方法、SOP 和工作流 |
| [`40-ExternalSources/`](../src/40-ExternalSources) | 外部资料分析卡，不保存第三方全文 |
| [`00-AI/templates/`](../src/00-AI/templates) | 标准模板 |
| [`docs/`](.) | 首次体验指南、架构图和面向使用者的说明文档 |
| [`00-AI/scripts/`](../src/00-AI/scripts) | 创建项目卡和巡检的轻量脚本 |
