...
test -f "$BAREBONE_TARGET/00-AI/recall/example-recall-chain.md"
test -f "$BAREBONE_TARGET/00-AI/recall/recall-fields.md"
...
test -f "$BAREBONE_TARGET/20-SharedAssets/01-user-assets/README.md"
...
test -f "$BAREBONE_TARGET/00-AI/templates/TPL-incident-experience-card.md"
test -f "$BAREBONE_TARGET/00-AI/templates/TPL-question-knowledge-experience-asset-card.md"
...
test -f "$ZH_TARGET/30-经验资产/06-本地经验/README.md"
