...
python3 "$ROOT/src/00-AI/scripts/kb.py" install-core "$VAULT" --mode full >/dev/null
python3 "$ROOT/src/00-AI/scripts/kb.py" upgrade-core "$VAULT" --mode full --dry-run >/tmp/kb-upgrade-dry-run.log
